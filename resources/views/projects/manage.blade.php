            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach($projects as $project)
                    ...
                    @if($isPrivileged || $isAssigned)
                        <a href="{{ route('projects.show', $project->id) }}" class="group relative bg-[#0f0f0f] rounded-xl border border-gray-700 hover:border-[#e0bb35]/50 transition-all duration-300 shadow-2xl flex flex-col">
                            <div class="p-6 grow">
