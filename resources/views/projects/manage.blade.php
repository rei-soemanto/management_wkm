            ...
            <div class="w-2/3 md:w-1/3">
                <form method="GET" action="{{ route('projects.index') }}" class="relative">
                    <input type="text" 
                        ...
                        placeholder="Search project, client, or details..." 
                        class="w-full bg-[#0f0f0f] border border-[#e0bb35] text-gray-300 rounded-md py-2 px-4 focus:outline-none focus:ring-1 focus:ring-[#e0bb35] placeholder-gray-500">
