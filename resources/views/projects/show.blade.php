                                ...
                                <div class="relative pb-8">
                                    ...
                                    <div class="relative flex space-x-3">
                                        ...
                                        <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                            ...
                                            @if(Auth::user()->userRole->name === 'Admin')
                                                <a href="{{ route('projects.tasks.update', $task->id) }}" class="text-[#e0bb35] hover:text-[#e3cf85] font-bold">Change Status</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="bg-[#0f0f0f] rounded-xl shadow-sm border border-gray-800 p-6">
                ...
                <form action="{{ route('projects.progress.store', $project->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-[#e0bb35]">New Status</label>
