    ...
    <div class="relative flex flex-col min-h-screen">
        <div class="flex-grow flex items-center justify-center py-12 text-center px-4">
            ...
            <div>
                ...
                <div class="mt-12">
                    <a href="https://afl3.thewkm.com" class="inline-block px-8 py-3 text-lg font-bold text-black bg-[#e0bb35] rounded hover:bg-[#e3cf85] transition duration-300 ease-in-out shadow-lg">
                        Go Back Home
                    </a>
                </div>
            </div>
