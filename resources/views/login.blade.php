        ...
        <div class="p-8">
            ...
            <div class="flex border-b border-white/20 mb-6">
                <button id="tab-login" onclick="switchTab('login')" 
                    class="w-1/2 py-3 text-center text-sm font-bold uppercase tracking-wider border-b-2 border-yellow-500 text-yellow-500 transition-colors duration-300 focus:outline-none">
                    Login
                </button>
                    ...
                    <form action="{{ route('login') }}" method="POST" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" required
                                class="block w-full rounded-lg border-transparent bg-white/20 text-white placeholder-gray-300 focus:border-yellow-500 focus:bg-white/30 focus:ring-0 transition-all py-2.5 px-4 sm:text-sm">
                        </div>
                        ...
                        <button type="submit" 
                            class="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-bold text-white bg-yellow-600 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 transition-transform transform hover:-translate-y-0.5">
                            Login
                        </button>
                    </form>
                </div>
...
<script>
    function switchTab(tab) {
        ...
        const activeClasses = ['border-yellow-500', 'text-yellow-500'];
